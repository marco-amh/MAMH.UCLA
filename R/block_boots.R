#' Block Bootstrapping
#' @description This function is to perform block bootstrapping which is more convenient
#' for time series. This function only allows correlations by the moment, but it will be
#' improved hopefully during Winter Term.
#' @param k Number of blocks
#' @param B Bootstraps
#' @param data_bb Data in data frame format. Only two variables.
#'
#' @return
#' @export
#'
