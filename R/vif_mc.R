...
#' @description This function is to detect Multicollinearity among the explanatory variables.
#' @param data_vif Data in matrix format. Only include the regressors. Omit the dependent variable.
#'
#' @return
#' @export
#'
