#' INEGI API
#' @description This function is useful to import quickly data sets from National Institute of
#' Statistis of Mexico (INEGI).
#' You just need the to type the series id.
