...
#' @description This function provides useful graphs of the residuals, as well as the Jarque Bera Test
#'calculated by hand.
#' @param model results from ols or ols_se_white  function
#' @param cl
#'
#' @return
#' @export
