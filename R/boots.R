#' Bootstrapping
#' @description This function is to perform bootstrapping and only works for correlations by
#' the moment, but it will be improved hopefully during Winter Term.
#' @param B Bootstraps
#' @param data Data in data frame.
#'
#' @return
#' @export
#'
