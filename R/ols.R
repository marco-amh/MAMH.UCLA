...
#' @description This function estimates the parameters by Ordinary Least Squares. This
#' was created manually with matrix algebra and it is useful to create other statistics inside
#' the function.
